...
from config import FORCE_SUB_CHANNEL, ADMINS, FORCE_SUB_CHANNEL2, FORCE_SUB_CHANNEL3, FORCE_SUB_CHANNEL4, OWNER_ID
...
async def get_infosudo(client:Client):
    a = await client.get_chat(OWNER_ID)
    return a
